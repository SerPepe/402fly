# 402fly - Go Implementation Guide

Complete guide for using 402fly with Go to build payment-enabled APIs and clients.
...
402fly for Go provides a complete implementation of the X402 protocol, enabling:
...
**Fly402Client (Explicit):**

```go
client := client.NewFly402Client(keypair, "", nil, false)
defer client.Close()
...
### net/http Middleware (`402fly-nethttp`)
...
- [X402 Protocol Specification](docs/402fly-technical-spec.md)
