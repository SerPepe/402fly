...
402fly is a library ecosystem that implements the [X402 protocol](https://www.x402.org/x402-whitepaper.pdf) - an open standard for enabling AI agents to autonomously pay for API access using HTTP 402 "Payment Required" status code and blockchain micropayments on Solana.
...
🚀 **[Technical Specification](docs/402fly-technical-spec.md)** - Complete architecture
...
402fly is released under the [MIT License](LICENSE).
