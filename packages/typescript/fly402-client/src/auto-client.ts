...
import { PaymentRequiredError, PaymentAuthorization } from '@402fly/core';
import { Fly402Client } from './explicit-client';

export class Fly402AutoClient {
  private client: Fly402Client;
  ...
  constructor(
    ...
    this.client = new Fly402Client(walletKeypair, rpcUrl);
