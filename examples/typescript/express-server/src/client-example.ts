 ...
 *
 * Demonstrates how to use the Fly402AutoClient to access paid API endpoints.
 */

import { Keypair } from "@solana/web3.js";
import { Fly402AutoClient, Fly402Client } from "@402fly/client";
import * as fs from "fs";
import * as path from "path";

// Example 1: Using Fly402AutoClient (Automatic Payment Handling)
...
// Example 2: Using Fly402Client (Manual Payment Control)
async function exampleManualClient() {
  ...
  const client = new Fly402Client(keypair, "https://api.devnet.solana.com");
