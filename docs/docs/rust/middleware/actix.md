...
The `402fly-actix` crate provides integration with the Actix Web framework for protecting endpoints with X402 payment requirements.
...
- `Fly402Config` and `X402State` - Server configuration
