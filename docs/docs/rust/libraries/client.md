...
- **Fly402AutoClient** - Automatically detects and handles 402 responses
- **Fly402Client** - Explicit control over payment flow
...
let client = Fly402AutoClient::new(keypair, None, None);
