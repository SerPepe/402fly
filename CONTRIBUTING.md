# Contributing to 402fly

Thank you for your interest in contributing to 402fly! This document provides guidelines and instructions for contributing.
...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/402fly.git
cd 402fly
...
# Type checking
mypy packages/python/402fly-core
```
...
```
packages/python/
├── 402fly-core/          # Core protocol - no framework dependencies
├── 402fly-fastapi/       # FastAPI-specific code
├── 402fly-client/        # HTTP client implementation
